...
contract ControlledToken is ERC20PermitUpgradeable, ControlledTokenInterface {
  ...
  uint256 public minimumChance;
  uint256 public notWinThreshold;
  uint256 public notWinOdds;
    ...
    initializer
  {
    ...
    __ERC20Permit_init("PoolGo ControlledToken");
  ...
  function setParameters(uint256 _reduceRate,uint256 _minimumChance,uint256 _notWinThreshold,uint256 _notWinOdds) external virtual onlyController {
    reduceRate = _reduceRate;
    minimumChance = _minimumChance;
    notWinThreshold = _notWinThreshold;
    notWinOdds = _notWinOdds;
  }

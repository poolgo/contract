...
contract CfxStakePrizePoolV2 is PrizePool {
  ...
  function _redeem(uint256 amount) internal override returns (uint256) {
    require(false, "CfxStakePrizePoolV2/failed");
